...
const authenticateJWT = (req, res, next) => {
    ...
    jwt.verify(token, JWT_SECRET, (err, user) => {
        ...
        if (exp - now < 300) { // If less than 5 minutes till expiration
            // Refresh the token
...
const middlewares = [errorHandler, logger, requestTime, jsonMiddleware, corsMiddleware, CookieParser, refreshCookie];

export { middlewares, hashPW, checkPW, signJWT, verifyJWT, bcrypt, authenticateJWT, setCookie }; // Export utility functions
